...
<html>
    ...
    <body>
        ...
        <div id="description">
            ...
            <div id="err">
                К сожалению, система не может обработать ваш запрос, так как
                <br>
                    <% if (request.getAttribute("err").equals("simbol")) {
                            out.println("вы ввели цифру или английские буквы.");
                        } else if (request.getAttribute("err").equals("pronoun")) {
                            out.println("невозможно подобрать корректные синонимы к местоимениям.");
                        } else if (request.getAttribute("err").equals("obscene")) {
                            out.println("система не предназначена для поиска синонимов к нецензурным выражениям.");
                        } else if (request.getAttribute("err").equals("number")) {
                            out.println("вы ввели число, но не выбрали словарь для числительных");
                        }
                    %>
                <br>
                Введите новое слово или выберите другой словарь.
            </div>
